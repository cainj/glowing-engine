package com.example.graphql.sample.datafetchers
...
/**
 * Custom DataFetcherFactory provider that returns custom Spring based DataFetcherFactory
 * for resolving lateinit properties.
 */
