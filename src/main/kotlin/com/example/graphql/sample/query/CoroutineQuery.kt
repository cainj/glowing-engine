...
class CoroutineQuery : Query {
    ...
    suspend fun slowFunction(msg: String): String {
        ...
        logger.info(
            "CoroutineQuery.slowFunction - computed slow result in " +
                    "${System.currentTimeMillis() - slowFunctionStart} ms"
        )
        return slowResult
    }
    ...
    suspend fun fastFunction(msg: String): String {
        ...
        delay(200L)
        logger.info(
            "CoroutineQuery.fastFunction - computed fast result in " +
                    "${System.currentTimeMillis() - fastFunctionStart} ms"
        )
        return msg
    }
}
